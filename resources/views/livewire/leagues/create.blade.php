<div class="min-h-screen bg-gray-50 py-4 sm:py-6 lg:py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 sm:mb-8">
            ...
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mt-4">Crear Nueva Liga</h1>
            <p class="mt-1 text-sm text-gray-600">Completa la información para crear una nueva liga deportiva</p>
        </div>
