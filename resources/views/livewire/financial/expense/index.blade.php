        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                    ...
                    @else
                        Control de pagos a árbitros, alquileres y otros gastos
                    @endif
                </p>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                @if($leagues->count() > 1)
                    <select wire:model.live="leagueFilter" 
                            class="px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent bg-white font-medium">
                ...
                @if(auth()->user()->user_type === 'admin' || auth()->user()->user_type === 'league_manager')
                    <a href="{{ route('financial.expense.create', ['leagueId' => $leagueFilter ?: null]) }}" 
        ...
        @if($currentLeague)
            <nav class="mb-4 text-sm">
                <ol class="flex items-center gap-2 text-gray-500">
                    <li><a href="{{ route('leagues.index') }}" class="hover:text-red-600">Ligas</a></li>
                    <li>/</li>
                    <li><a href="{{ route('financial.dashboard', $currentLeague->id) }}" class="hover:text-red-600">{{ $currentLeague->name }}</a></li>
                    <li>/</li>
                    <li class="text-gray-900 font-medium">Gastos</li>
                </ol>
            </nav>
        @endif
