                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 mb-4">
                            ...
                            <div class="flex justify-between">
                                ...
                                <span class="text-lg font-bold text-green-600">${{ number_format($expense->amount, 2) }} MXN</span>
                            </div>
                        </div>
                            ...
                            <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-green-700 text-sm">El pago en efectivo ha sido registrado correctamente.</p>
                                    </div>
                                </div>
                            </div>
                        @else
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea wire:model="notes" rows="3"
                                                  class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                                                  placeholder="Ej: Pago recibido en mano"></textarea>
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        @if($paymentSuccess)
                            <button wire:click="closeModal"
                                    class="w-full sm:w-auto inline-flex justify-center rounded-lg border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none sm:ml-3">
                                Cerrar
                            </button>
                        @else
